...
const commonStains = [
  {
    icon: Flame,
    title: "Oil & Motor Grease",
    desc: "Leaking engines, hydraulic fluids, and lawn mower drips that penetrate deep into concrete pores.",
  },
  {
    icon: AlertTriangle,
    title: "Tire Rubber Marks",
    desc: "Black friction scuffs from turning wheels, hot tires, and heavy delivery trucks.",
  },
  {
    icon: MapPin,
    title: "Red Clay & Ground-In Dirt",
    desc: "North Carolina red clay dust and foot-traffic mud embedded in surface crevices.",
  },
  {
    icon: ShieldAlert,
    title: "Algae, Moss & Mildew",
    desc: "Slippery green and black film in shaded zones that create severe fall risks when wet.",
  },
  {
    icon: Zap,
    title: "Rust & Mineral Deposits",
    desc: "Irrigation rust stains, battery acid burns, and mineral efflorescence marks.",
  },
  {
    icon: Sparkles,
    title: "General Grime & Weathering",
    desc: "Years of atmospheric pollution and sun fading that make pavement look aged and dull.",
  },
];

const hotWaterAdvantages = [
  {
    icon: Flame,
    title: "Hot Water Emulsification",
    desc: "Unlike cold water pressure that just scatters surface grease, our hot water system (up to 200°F) melts oil at the molecular level.",
  },
  {
    icon: Leaf,
    title: "Eco-Friendly Pre-Treatments",
    desc: "EPA-registered, biodegradable degreasers breakdown stubborn stains before washing without harming surrounding lawns.",
  },
  {
    icon: ShieldCheck,
    title: "Surface-Safe Pressure Control",
    desc: "Calibrated rotary surface cleaners clean evenly without leaving ugly wand lines, etching concrete, or loosening paver sand.",
  },
  {
    icon: Award,
    title: "15 Years Local Experience",
    desc: "Owner David Hudson understands Lake Norman soil conditions and exact chemical formulas for maximum stain lifting.",
  },
];

const drivewayBenefits = [
  {
    title: "Maximize Curb Appeal & Home Value",
    desc: "A bright, stain-free driveway immediately transforms your entryway and elevates buyer perception.",
  },
  {
    title: "Eliminate Fall & Slip Hazards",
    desc: "Removes slick algae, mold spores, and slippery motor oil for safe family and guest walking.",
  },
  {
    title: "Extend Pavement Lifespan",
    desc: "Stops corrosive engine oils and road salt from eating away concrete binders and causing pitting.",
  },
  {
    title: "Ideal Surface Prep for Sealing",
    desc: "Essential deep-clean preparation before applying concrete acrylic sealers, epoxy, or stains.",
  },
];

const drivewayProcess = [
  {
    icon: Search,
    title: "Free On-Site Assessment",
    desc: "We inspect driveway material, stain types, and square footage to provide an upfront, transparent quote.",
  },
  {
    icon: Shield,
    title: "Targeted Stain Pre-Treatment",
    desc: "We apply specialized biodegradable degreasers directly to oil spots and algae zones.",
  },
  {
    icon: Droplets,
    title: "Hot-Water Deep Scrub",
    desc: "Commercial rotary surface cleaners scour pavement with 200°F hot water to lift embedded grime.",
  },
  {
    icon: BadgeCheck,
    title: "Rinse & Final Walkthrough",
    desc: "We rinse all slurry, clean adjacent walkways, and conduct a final walkthrough with you.",
  },
];
...
export function DrivewayCleaningPage() {
  return (
    <div className="w-full bg-background overflow-hidden">
      ...
      >
        ...
        <div className="relative z-20 max-w-4xl w-full flex flex-col items-center space-y-4 sm:space-y-6 text-white text-center">
          ...
          >
            ...
            <span>Professional Driveway &amp; Pavement Cleaning</span>
          </motion.div>
          ...
          >
            ...
            >
              Restore Your Driveway to Like-New.
            </span>
          </h1>
          ...
          >
            Your driveway is the welcome mat to your home. Over time, motor oil, tire scuffs, and red clay stain the surface. Using our commercial hot water pressure washing system, we melt deep-set grease and erase years of weathering to restore crisp curb appeal.
          </motion.p>
          ...
          >
            ...
            <span className="text-[9px] sm:text-[10px] font-bold text-neutral-300 uppercase tracking-wide">Hot-Water Driveway Restoration Specialists</span>
          </motion.div>
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 justify-center">
              {[
                { label: "200°F Hot Water Wash", sub: "Melts Motor Oil & Grease" },
                { label: "Rotary Surface Scrub", sub: "No Wand Lines or Etching" },
                { label: "15 Years Experience", sub: "Licensed & Insured Team" },
              ].map(({ label, sub }) => (
      ...
      {/* ═══════════════════════════════════════════════════════════
          COMMON DRIVEWAY STAINS WE REMOVE
      ═══════════════════════════════════════════════════════════ */}
      <section id="stains-removed" className="relative py-[60px] overflow-hidden bg-slate-50/50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-16 lg:grid-cols-12 lg:items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              >
                <DrivewayIcon />
                <span>Common Driveway Stains We Remove</span>
              </motion.div>
              ...
              >
                Driveways suffer relentless exposure to vehicle fluids, hot tires, and red clay runoff. Cold water pressure washing only pushes dirt deeper into concrete pores. Our hot-water system emulsifies and lifts stubborn stains completely.
              </motion.p>
              ...
              >
                {commonStains.map((stain) => {
                  const Icon = stain.icon;
                  return (
                    <div key={stain.title} className="bg-white border border-slate-200/80 rounded-2xl p-4 shadow-sm text-left flex flex-col justify-between">
                      <div>
                        <div className="flex items-center gap-2 mb-1.5">
                          <Icon className="w-4 h-4 text-[#0ea5e9] shrink-0" />
                          <h4 className="text-xs font-black text-slate-900 uppercase tracking-wider">{stain.title}</h4>
                        </div>
                        <p className="text-xs text-slate-500 leading-relaxed font-medium">{stain.desc}</p>
                      </div>
                    </div>
                  );
                })}
            ...
            <div className="lg:col-span-5 flex justify-center">
              ...
              >
                ...
                <div className="relative w-full h-[460px] sm:h-[520px] rounded-t-full overflow-hidden shadow-2xl border-4 border-white bg-slate-900 group">
                  <img
                    src={svcDriveway}
                    alt="Steam On Wheels Driveway Wash"
                  ...
                  <div className="absolute bottom-6 left-6 right-6 bg-slate-950/85 backdrop-blur-md border border-white/10 rounded-2xl p-4 text-left shadow-2xl">
                    ...
                    <p className="text-xs font-extrabold text-white mt-0.5">COMMERCIAL HOT WATER OIL &amp; STAIN DEGREASING</p>
                  </div>
                </div>
              </motion.div>
            </div>
      ...
      {/* ═══════════════════════════════════════════════════════════
          THE HOT WATER ADVANTAGE (4 Pillars Grid)
      ═══════════════════════════════════════════════════════════ */}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-[#0ea5e9]/10 border border-[#0ea5e9]/20 px-4 py-1.5 rounded-full shadow-sm mb-4">
              ...
              <span className="text-[10px] sm:text-xs font-extrabold uppercase tracking-wider text-[#0284c7]">The Hot Water Advantage</span>
            </div>
            <h2 className="text-slate-900 tracking-tight text-[28px] sm:text-[38px] leading-tight font-extrabold" style={{ fontWeight: 800 }}>
              Why Hot Water Beats <span className="text-[#0ea5e9]">Standard Cold Power Washing</span>
            </h2>
          </motion.div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {hotWaterAdvantages.map((adv, index) => {
              const Icon = adv.icon;
              return (
                <motion.div
                  key={adv.title}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-white border border-slate-200/80 px-4 py-1.5 rounded-full shadow-sm mb-4">
              ...
              <span className="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-slate-700">Core Homeowner Benefits</span>
            </div>
            <h2 className="text-slate-900 tracking-tight text-[30px] sm:text-[38px] md:text-[44px] leading-tight max-w-3xl mx-auto font-extrabold" style={{ fontWeight: 800 }}>
              4 Key Advantages of <span className="text-[#0ea5e9]">Professional Driveway Wash</span>
            </h2>
          </motion.div>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {drivewayBenefits.map((b, idx) => (
              <motion.div
                key={b.title}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                ...
                className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm text-left flex items-start gap-4"
              >
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#0ea5e9]/10 text-[#0ea5e9] shrink-0 font-extrabold text-sm">
                  0{idx + 1}
                </div>
                <div>
      ...
      {/* ═══════════════════════════════════════════════════════════
          OUR SERVICE PROCESS (4-Step Timeline Grid)
      ═══════════════════════════════════════════════════════════ */}
        ...
        <div className="mx-auto max-w-[1400px] w-full relative">
          ...
          <div className="mx-auto w-[90%] max-w-7xl relative z-10">
            ...
            >
              ...
              >
                From free assessment to final walkthrough, we restore your driveway's true beauty.
              </p>
            </motion.div>
      ...
      <section className="py-12 bg-white border-b border-slate-100">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-xs font-extrabold uppercase tracking-widest text-slate-400 mb-4">
            Serving Driveway &amp; Pavement Cleaning Clients Across Mooresville &amp; Surrounding Region
          </p>
      ...
      <section className="relative w-full overflow-hidden py-[60px] text-white bg-[#090d16] border-t border-white/5">
        ...
        <div className="relative z-20 mx-auto w-[90%] max-w-4xl text-center flex flex-col items-center space-y-6">
          ...
          >
            ...
            Ready for a Driveway That Makes a Statement?
          </motion.div>
          ...
          <motion.h2
            ...
            style={{ fontWeight: 800 }}
          >
            Contact David Hudson for a Free Driveway Cleaning{" "}
            <span
              style={{
                background: "linear-gradient(to right,#38bdf8,#3b82f6)",
                WebkitBackgroundClip: "text",
          ...
          <div className="flex items-center justify-center gap-2 text-xs text-neutral-400 select-none pt-2">
            ...
            <span>Steam On Wheels: Where Deep Clean Meets Lasting Impression.</span>
          </div>
        </div>
      </section>
