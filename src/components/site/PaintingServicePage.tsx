...
const PaintIcon = () => (
  <svg className="w-3.5 h-3.5 text-[#0ea5e9] fill-[#0ea5e9] shrink-0" viewBox="0 0 24 24">
    <path d="M18 4V3c0-.55-.45-1-1-1H7c-.55 0-1 .45-1 1v1H4c-.55 0-1 .45-1 1v4c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-.55-.45-1-1-1h-2zM6 8V6h12v2H6zm13 3H5c-1.1 0-2 .9-2 2v6c0 1.1.9 2 2 2h3v2c0 .55.45 1 1 1h6c.55 0 1-.45 1-1v-2h3c1.1 0 2-.9 2-2v-6c0-1.1-.9-2-2-2zm-5 9h-4v-4h4v4z" />
  </svg>
);
...
const paintingServices = [
  {
    title: "Full Home & Commercial Repainting",
    desc: "Complete exterior color transformation for residential homes, office buildings, and retail properties with expert color guidance.",
  },
  {
    title: "Accent, Trim & Shutter Painting",
    desc: "High-precision detail painting for front doors, window sills, fascia, eaves, and decorative shutters to make architectural features pop.",
  },
  {
    title: "Deck, Fence & Porch Staining",
    desc: "Restores, seals, and stains wooden decks, handrails, pergolas, and privacy fences against rain and intense UV breakdown.",
  },
  {
    title: "Garage & Outbuilding Uniformity",
    desc: "Refreshes detached garages, sheds, workshops, and storage facilities so all structures match seamlessly.",
  },
  {
    title: "Preparation & Power Wash Prep",
    desc: "Deep pressure wash cleaning to strip chalky residue, dirt, and loose paint flakes—ensuring maximum primer and paint adhesion.",
  },
  {
    title: "Surface Repair, Caulk & Prime",
    desc: "Meticulous scraping, sanding rough wood grain, caulking seams, and applying high-adhesion primer for a perfectly smooth finish.",
  },
];

const paintingAdvantage = [
  {
    icon: Droplets,
    title: "Cleaning-First Surface Prep",
    desc: "Because exterior cleaning is our core expertise, we power wash surfaces to a pristine state—eliminating invisible mildew that causes paint peeling.",
  },
  {
    icon: Award,
    title: "Owner-Led Craftsmanship",
    desc: "David Hudson directly supervises every painting project, guaranteeing sharp trim lines, uniform coats, and zero overspray.",
  },
  {
    icon: ShieldCheck,
    title: "Premium Weather-Safe Paints",
    desc: "We exclusively use top-tier exterior paints & stains engineered to resist North Carolina's intense UV rays, humidity, and thermal expansion.",
  },
  {
    icon: HeartHandshake,
    title: "15 Years Local Insight",
    desc: "We know exactly which primer and paint formulations hold up best against Lake Norman's climate, protecting your home for a decade.",
  },
  {
    icon: Sparkles,
    title: "Seamless Property Bundle",
    desc: "Combine painting with roof soft washing, siding cleaning, or concrete degreasing for a total property refresh with one local team.",
  },
];

const whyRepaint = [
  {
    title: "Boost Property Value & Curb Appeal",
    desc: "A fresh exterior paint job is proven to deliver one of the highest returns on investment for homeowners and commercial owners.",
  },
  {
    title: "Shield Wood & Siding Against Rot",
    desc: "Paint acts as a waterproof shield against rain, moisture, UV degradation, and wood-boring insects.",
  },
  {
    title: "Modernize Your Architectural Style",
    desc: "Transform outdated color schemes with sleek modern tones that harmonize with your landscape and neighborhood.",
  },
];
...
const paintingProcess = [
  {
    ...
    desc: "We inspect your property exterior, discuss color options, and provide a clear, itemized proposal.",
  },
  {
    icon: Shield,
    title: "Power Wash & Surface Prep",
    desc: "We clean all surfaces with pressure washing, scrape peeling paint, sand rough edges, caulk seams, and apply primer.",
  },
  {
    icon: Paintbrush,
    title: "Precision Paint Application",
    desc: "Our skilled painters apply premium coats with expert technique, achieving uniform thickness and razor-sharp trim edges.",
  },
  {
    icon: Sparkles,
    title: "Detail Work & Site Cleanup",
    desc: "We touch up intricate details, remove protective masking tape, and perform a full property cleanup.",
  },
  {
    icon: BadgeCheck,
    title: "Final Client Walkthrough",
    desc: "We inspect the finished project with you to ensure 100% delight before signing off.",
  },
];
...
export function PaintingServicePage() {
  return (
    <div className="w-full bg-background overflow-hidden">
      ...
      >
        ...
        <div className="relative z-20 max-w-4xl w-full flex flex-col items-center space-y-4 sm:space-y-6 text-white text-center">
          ...
          >
            ...
            <span>Professional Exterior Painting Services</span>
          </motion.div>
          ...
          >
            Refresh, Protect &amp; Beautify Your Property with{" "}
            <span
              style={{
          ...
          >
            The right coat of paint rejuvenates character and provides crucial weather protection. Combining our 15 years of exterior cleaning expertise with skilled painting craftsmanship, David Hudson delivers flawless, long-lasting finishes for residential and commercial properties.
          </motion.p>
          ...
          >
            ...
            <span className="text-[9px] sm:text-[10px] font-bold text-neutral-300 uppercase tracking-wide">Flawless Exterior Painting in Lake Norman</span>
          </motion.div>
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 justify-center">
              {[
                { label: "Cleaning-First Prep", sub: "Power Washed Before Painting" },
                { label: "Premium Paints", sub: "Weather-Resistant Formulas" },
                { label: "Owner-Led Quality", sub: "David Hudson Direct Oversight" },
              ].map(({ label, sub }) => (
      ...
      {/* ═══════════════════════════════════════════════════════════
          COMPREHENSIVE PAINTING SERVICES GRID
      ═══════════════════════════════════════════════════════════ */}
      <section id="painting-services" className="relative py-[60px] overflow-hidden bg-slate-50/50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-16 lg:grid-cols-12 lg:items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              >
                <PaintIcon />
                <span>Our Comprehensive Painting Services</span>
              </motion.div>
              ...
              >
                ...
                >
                  Applied with Meticulous Precision.
                </span>
              </motion.h2>
              ...
              >
                From complete building repaints to detailed shutter and trim accenting, we provide a seamless, high-quality result. Every project begins with professional pressure wash prep to guarantee paint adhesion that lasts.
              </motion.p>
              ...
              >
                {paintingServices.map((svc) => (
                  <div key={svc.title} className="bg-white border border-slate-200/80 rounded-2xl p-4 shadow-sm text-left flex flex-col justify-between">
                    <div>
                      <div className="flex items-center gap-2 mb-1.5">
                        <Paintbrush className="w-4 h-4 text-[#0ea5e9] shrink-0" />
                        <h4 className="text-xs font-black text-slate-900 uppercase tracking-wider">{svc.title}</h4>
                      </div>
            ...
            {/* Right: Showcase Image Container with SOFT WASH Circle Badge OUTSIDE overflow-hidden */}
            <div className="lg:col-span-5 flex justify-center">
              ...
              >
                ...
                <div className="relative w-full h-[460px] sm:h-[520px] rounded-t-full overflow-hidden shadow-2xl border-4 border-white bg-slate-900 group">
                  <img
                    src={serviceHouseImg}
                    alt="Steam On Wheels Professional Exterior Painting"
                  ...
                  <div className="absolute bottom-6 left-6 right-6 bg-slate-950/85 backdrop-blur-md border border-white/10 rounded-2xl p-4 text-left shadow-2xl">
                    ...
                    <p className="text-xs font-extrabold text-white mt-0.5">PREPARATION-DRIVEN EXTERIOR PAINTING</p>
                  </div>
                </div>
              </motion.div>
            </div>
      ...
      {/* ═══════════════════════════════════════════════════════════
          THE STEAM ON WHEELS PAINTING ADVANTAGE (5 Pillars)
      ═══════════════════════════════════════════════════════════ */}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-[#0ea5e9]/10 border border-[#0ea5e9]/20 px-4 py-1.5 rounded-full shadow-sm mb-4">
              ...
              <span className="text-[10px] sm:text-xs font-extrabold uppercase tracking-wider text-[#0284c7]">The Painting Advantage</span>
            </div>
            <h2 className="text-slate-900 tracking-tight text-[28px] sm:text-[38px] leading-tight font-extrabold" style={{ fontWeight: 800 }}>
              Why Choose Us for Your <span className="text-[#0ea5e9]">Exterior Painting Project</span>
            </h2>
          </motion.div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {paintingAdvantage.map((adv, index) => {
              const Icon = adv.icon;
              return (
                <motion.div
                  key={adv.title}
      ...
      {/* ═══════════════════════════════════════════════════════════
          WHY REFRESH YOUR EXTERIOR PAINT?
      ═══════════════════════════════════════════════════════════ */}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-white border border-slate-200/80 px-4 py-1.5 rounded-full shadow-sm mb-4">
              ...
              <span className="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-slate-700">Value &amp; Protection</span>
            </div>
            <h2 className="text-slate-900 tracking-tight text-[30px] sm:text-[38px] md:text-[44px] leading-tight max-w-3xl mx-auto font-extrabold" style={{ fontWeight: 800 }}>
              3 Key Reasons to <span className="text-[#0ea5e9]">Repaint Your Exterior</span>
            </h2>
          </motion.div>

          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {whyRepaint.map((item, idx) => (
              <motion.div
                key={item.title}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                ...
                className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm text-left flex flex-col justify-between"
              >
                <div>
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#0ea5e9]/10 text-[#0ea5e9] mb-4 font-extrabold text-sm">
                    0{idx + 1}
                  </div>
      ...
      {/* ═══════════════════════════════════════════════════════════
          OUR METICULOUS PAINTING PROCESS (5-Step Timeline Grid)
      ═══════════════════════════════════════════════════════════ */}
        ...
        <div className="mx-auto max-w-[1400px] w-full relative">
          ...
          <div className="mx-auto w-[90%] max-w-7xl relative z-10">
            ...
            >
              ...
              >
                From consultation to final walkthrough, we execute every detail with craftsman precision.
              </p>
            </motion.div>

            {/* Desktop 5-Step Timeline Grid */}
            <div className="hidden lg:block relative w-full h-[320px] select-none">
              ...
              >
                <path d="M 80 50 L 1120 50" stroke="#1e293b" strokeWidth="10" strokeLinecap="round" />
                <motion.path
                  d="M 80 50 L 1120 50"
                  stroke="#0ea5e9"
                  strokeWidth="6"
                ...
                />
                <path d="M 80 50 L 1120 50" stroke="#e0f2fe" strokeWidth="3" strokeLinecap="round" opacity="0.8" className="spark-flow" />
              </svg>

              {paintingProcess.map((s, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="absolute top-[48px] -translate-x-1/2 text-center w-[200px] flex flex-col items-center pt-1">
                      <h3 className="font-extrabold text-[14px] text-neutral-900 leading-tight mt-1 mb-1.5 group-hover:text-[#0284c7] transition-colors duration-300">
                        {s.title}
                      </h3>
      ...
      <section className="py-12 bg-white border-b border-slate-100">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-xs font-extrabold uppercase tracking-widest text-slate-400 mb-4">
            Serving Exterior Painting Clients Across Mooresville &amp; Surrounding Region
          </p>
      ...
      <section className="relative w-full overflow-hidden py-[60px] text-white bg-[#090d16] border-t border-white/5">
        ...
        <div className="relative z-20 mx-auto w-[90%] max-w-4xl text-center flex flex-col items-center space-y-6">
          ...
          <motion.h2
            ...
            style={{ fontWeight: 800 }}
          >
            Contact David Hudson for a Free Exterior Painting{" "}
            <span
              style={{
                background: "linear-gradient(to right,#38bdf8,#3b82f6)",
                WebkitBackgroundClip: "text",
          ...
          <div className="flex items-center justify-center gap-2 text-xs text-neutral-400 select-none pt-2">
            ...
            <span>Steam On Wheels: Expert Cleaning. Flawless Painting. One Trusted Team.</span>
          </div>
        </div>
      </section>
